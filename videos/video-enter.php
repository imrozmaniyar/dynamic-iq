    ...
    <section class="mt-3">
      <div class="container clearfix">
        <h2 class="article-news-listing-title"><a href="<?php echo $domain?>videos/entertainment" class="article-news-listing-title">تفریحی ویڈیوز</a></h2>
        <div class="row mt-4">
          <?php
            if ($videoenthome[0] > 0):
                $i = 1;
        ...
        <div class="row">
          <div class="col-md-12 text-left  mt-3">
            <a href="<?php echo $domain?>videos/entertainment" class=" read-more clearfix">مزید </a>
          </div>
        </div>
