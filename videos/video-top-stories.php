<section>
  <div class="container clearfix">
    ...
    <?php
      if ($videomain1[0] > 0):
        $i = 1;
          while ($objvideomain1s = mysql_fetch_object($videomain1[1])):
          $username           = $objvideomain1s->username;
          $nameID             = $objvideomain1s->name;
          if($username     =='Article'):
    ...
    ?>  
      <div class="row">
        ...
        <div class="col-md-6 order-1 order-md-2">
          <a href="<?php echo $domain?><?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href">
            <img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto" alt="" width="525px;" height="300px;"></a><div class="latest-text">Latest</div></div>
      </div>
      <?php
        endwhile;
      endif;  
      ...
      if ($videomain2[0] > 0):
        $i = 1;
          while ($objvideomain2s = mysql_fetch_object($videomain2[1])):
          $username           = $objvideomain2s->username;
          $nameID             = $objvideomain2s->name;
          if($username     =='Article'):
            $objAmaster    = new db_article_master($nameID);
            $hid           = $objAmaster->Get_article_id();
            $ht            = $objAmaster->Get_article_homepage_headline();
      ...
      ?>        
        <div class="col-md-3 zoom col-6 mt-3 mt-md-3">
          <a href="<?php echo $domain?><?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href">
            <img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" style="height:165px;" class="img-fluid mx-auto d-block" alt="">
