<!-- Sports Photos Section -->
    <section class="mt-3">
      <div class="container clearfix">
        <h2 class="article-news-listing-title"><a href="<?php echo $domain?>videos/sports" class="article-news-listing-title">کھیل کی تصاویر</a></h2>
        <div class="row mt-4">
          <?php
        ...
        <div class="row">
          <div class="col-md-12 text-left  mt-3">
            <a href="#" class=" read-more clearfix">مزید </a>
          </div>
        </div>
      </div>  
    </section>
