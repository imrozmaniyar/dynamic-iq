 ...
 <section class="mt-3">
      <div class="container clearfix">
        <div class="photo-section-bg p-3">
          <div class="col-md-12">
            <h1 class="photo-section-title"><a href="<?php echo $domain?>photos/news" class="text-white">تفریحی تصاویر</a></h1>
          </div>
          <div class="row">
          <?php
              if ($entpphoto[0] > 0):
          ...
          <div class="row">
          <a href="<?php echo $domain?>photos/news" class="text-left read-more mt-3 clearfix">مزید </a>
        </div>
        </div>
