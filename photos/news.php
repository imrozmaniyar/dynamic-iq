      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            ...
            <li class="breadcrumb-item active font-weight-bold" aria-current="page"><a href="<?php echo $domain?>photos" class="text-black" alt="Photos" title="Phots">  ویڈیوز </a></li>
        ...
        <?php include('pnews-one.php'); ?>
      </div>  
    </section>
    <!-- first section -->

    <!-- Entertainment Photos Section -->
    <?php include('pnews-two.php'); ?>
...
?>     
    <section class="mt-3">
        ...
        <h2 class="article-news-listing-title mb-0" alt="News" title="News"> خبریں  </h2>
        <div class="row">
		<?php
