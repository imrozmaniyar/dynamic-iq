      ...
      <div class="row">
        ...
        <div class="col-md-6 order-1 order-md-2">
          <a href="<?php echo $domain?><?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href">
            <img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto first-section-img" alt="" width="525px;" height="300px;"></a><div class="latest-text">Latest</div></div>
      </div>
      <?php
        endwhile;
      endif;  
