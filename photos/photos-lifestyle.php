<section class="mt-3">
      <div class="container clearfix">
        <h2 class="article-news-listing-title"><a href="<?php echo $domain?>photos/lifestyle" class="article-news-listing-title">نیوز ویڈیوز </a></h2>
        <div class="row mt-4">
          <?php
          ...
          <div class="col-md-4 order-2 order-md-0">
              ...
              <div class="card-shadow zoom">
                <img src="<?php echo $domain?><?php echo htmlspecialchars($pImage,ENT_QUOTES, 'UTF-8')?>" class="img-fluid mx-auto d-block photo-gallery-img" alt="">
        ...
        <div class="row">
          <div class="col-md-12 text-left  mt-3">
            <a href="<?php echo $domain?>photos/lifestyle" class=" read-more clearfix">مزید </a>
          </div>
        </div>
