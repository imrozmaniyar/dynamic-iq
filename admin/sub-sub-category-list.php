...
include(DIR_WS_CLASS."db_sub_sub_category_master.php");
include(DIR_WS_CLASS."messages.php");
$cid    = intval($_GET['cid']);
$objh   = new db_category_master($cid);
$title  = $objh->Get_category_master_name();
$sid    = intval($_GET['sid']);
$objhs  = new db_sub_category_master($sid);
$stitle = $objhs->Get_sub_category_master_name();
$msgId  ="";
$obj = new db_sub_sub_category_master;
$strWhere="category_master_id=$cid and sub_category_master_id=$sid";
...
if(($strfdate !== "") && ($strtdate !== "")):
        $strWhere = "sub_sub_category_master_date BETWEEN '$newfdate1' AND '$newtdate1'"; 
    endif;
    if($strsadmin !== ""):
        if($strWhere==""):
     ...
     if($strsvid !== ""):
        if($strWhere==""):
            $strWhere .= "sub_sub_category_master_name_urdu LIKE '%$strsvid%'";
        else:    
           $strWhere .= " and sub_sub_category_master_name_urdu LIKE '%$strsvid%'";
        endif;
    endif; 

         if($strstitle !== ""):
        if($strWhere==""):
            $strWhere .= "sub_sub_category_master_name LIKE '%$strstitle%' ";
        else:    
           $strWhere .= " and sub_sub_category_master_name LIKE '%$strstitle%'";
        endif;
    endif;     
 if($strsstatus !== ""):
        if($strWhere==""):
...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Sub Sub Category List for : <?php echo htmlspecialchars($stitle,ENT_QUOTES, 'UTF-8')?>/<?php echo htmlspecialchars($title,ENT_QUOTES, 'UTF-8')?></h2>
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                <li><a href="adminhome.php"><i class="fa fa-home"></i></a></li>
                <!-- <li><span>Sub Sub Category List for : <?php echo htmlspecialchars($stitle,ENT_QUOTES, 'UTF-8')?>/<?php echo htmlspecialchars($title,ENT_QUOTES, 'UTF-8')?></span></li> -->
            </ol>
        ...
        <header class="panel-heading"><h2 class="panel-title"><font color="red"><b><?php echo $objMsg->get_message()?></b></font></h2></header>
         <?php endif;?>
                <div class="panel-body">
                    <form name="frminternet" method="post" action="<?php echo $domain?>admin/sub-sub-category-entry.php">
<div class="panel-body">
                       ...
                       <div class="panel-group" id="accordion2" >
                            <div class="panel panel-accordion panel-accordion-primary ">
                                <div class="panel-heading"><h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse2One"><i class="fa fa-cogs"></i> Filters</a></h4></div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 10px;margin-left: -15px";>
                                                                <!-- <input type="text" class="form-control" name="" id=""> -->
                                                                    <select class="form-control mb-md" id="sadmin" name="txtsadmin">
                                                                        ...
                                                                        <?php
                                                                            $objgener1 = new db_sub_sub_category_master;
                                                                            $strWhere = "category_master_id=$cid and sub_category_master_id=$sid";
                                             ...
                                             <div class="col-md-2">
                                                <table border='0'>
                                                    <tr><td><b>Sub Sub Category Identifier</b></td></tr>    
                                             ...
                                             <div class="col-md-2">
                                                <table border='0'>
                                                    <tr><td><b>Sub Sub Category Name</b></td></tr>    
                                    ...
                                    <a href="sub-sub-category-list.php?sid=<?php echo htmlspecialchars($sid,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>"><button type="button" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="licon-refresh"></i> Reset</button></a>
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo DIR_WS_ASSETS?>vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                    <div align="left">
                                        <a href="<?php echo $domain?>admin/sub-sub-category-entry.php?sid=<?php echo htmlspecialchars($sid,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>" class="btn btn-default">Add</a>
                <a href="#"  onclick="javascript:return callDelete();" class="btn btn-default">Delete</a>
                <a href="<?php echo $domain?>admin/subcategory-list.php?cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>" class="btn btn-default" id="myButton">Cancel</a>
                    ...
                    <thead>
                        <tr>
                            <th width="5%"></th>
                            <th width="5%">ID</th>
                            <th width="25%">Sub Sub Category Identifier</th>
                            <th width="25%">Sub Sub Category Name</th>
                    ...
                    <?php
                        ...
                        $sub_sub_category_master_date    = $objinternet->sub_sub_category_master_date;
                        $cdate         =  date("jS F Y h:i:s", strtotime($sub_sub_category_master_date)); 
                        $sub_sub_category_master_date1    = $objinternet->sub_sub_category_master_date1;
                        $mdate         =  date("jS F Y h:i:s", strtotime($sub_sub_category_master_date1)); 

                    ?>
                        <tr class="gradeX">
                            <td><input type="checkbox" name="chk<?php echo $i?>" value="<?php echo htmlspecialchars($objinternet->sub_sub_category_master_id,ENT_QUOTES, 'UTF-8')?>"/></td>
                            <td><?php echo htmlspecialchars($objinternet->sub_sub_category_master_id,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->sub_sub_category_master_name_urdu,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->sub_sub_category_master_name,ENT_QUOTES, 'UTF-8')?></td>
                            ...
                            <td align="center"><a href="<?php echo $domain?>admin/sub-sub-category-entry.php?ssid=<?php echo htmlspecialchars($objinternet->sub_sub_category_master_id,ENT_QUOTES, 'UTF-8')?>&sid=<?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($objinternet->category_master_id,ENT_QUOTES, 'UTF-8')?>"><img src="<?php echo DIR_WS_ASSETS?>images/user_edit.png" alt="Edit" title="Edit"/></a></td>
                        </tr>
                    <?php
                            endwhile;
                        endif;
                ...
                <input type="hidden" name="sid" id="sid" value="<?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?>">
                <input type="hidden" name="ssid" id="ssid" value="<?php echo htmlspecialchars($objinternet->sub_sub_category_master_id,ENT_QUOTES, 'UTF-8')?>">
...
<script language="javascript" type="TEXT/JAVASCRIPT">
    ...
    function callDelete(){
        ...
        {
          document.frminternet.action="<?php echo $domain?>admin/sub-sub-category-submit.php?mode=Delete&sid=<?php echo htmlspecialchars($sid,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>";
    ...
    function callSearch()
        ...
        document.frminternet.action="sub-sub-category-list.php?sid=<?php echo htmlspecialchars($sid,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>";
        document.frminternet.submit();
        }     
</script>
