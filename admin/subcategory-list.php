...
$msgId ="";
$obj = new db_sub_category_master;
$strWhere="category_master_id=$cid";
...
if(($strfdate !== "") && ($strtdate !== "")):
        $strWhere = "sub_category_master_date BETWEEN '$newfdate1' AND '$newtdate1'"; 
    endif;
    if($strsadmin !== ""):
        if($strWhere==""):
     ...
     if($strsvid !== ""):
        if($strWhere==""):
            $strWhere .= "sub_category_master_name_urdu LIKE '%$strsvid%'";
        else:    
           $strWhere .= " and sub_category_master_name_urdu LIKE '%$strsvid%'";
        endif;
    endif; 

         if($strstitle !== ""):
        if($strWhere==""):
            $strWhere .= "sub_category_master_name LIKE '%$strstitle%' ";
        else:    
           $strWhere .= " and sub_category_master_name LIKE '%$strstitle%'";
        endif;
    endif;     
 if($strsstatus !== ""):
        if($strWhere==""):
...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Sub Category List for : <?php echo htmlspecialchars($title,ENT_QUOTES, 'UTF-8')?></h2>
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                <li><a href="adminhome.php"><i class="fa fa-home"></i></a></li>
                <!-- <li><span>Sub Category List for : <?php echo htmlspecialchars($title,ENT_QUOTES, 'UTF-8')?></span></li> -->
            </ol>
        ...
        <header class="panel-heading"><h2 class="panel-title"><font color="red"><b><?php echo $objMsg->get_message()?></b></font></h2></header>
         <?php endif;?>
                <div class="panel-body">
                    <form name="frminternet" method="post" action="<?php echo $domain?>admin/subcategory-entry.php">
<div class="panel-body">
                       ...
                       <div class="panel-group" id="accordion2" >
                            <div class="panel panel-accordion panel-accordion-primary ">
                                <div class="panel-heading"><h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse2One"><i class="fa fa-cogs"></i> Filters</a></h4></div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-12" style="margin-bottom: 10px;margin-left: -15px";>
                                                                <!-- <input type="text" class="form-control" name="" id=""> -->
                                                                    <select class="form-control mb-md" id="sadmin" name="txtsadmin">
                                                                        ...
                                                                        <?php
                                                                            $objgener1 = new db_sub_category_master;
                                                                            $strWhere = "category_master_id=$cid";
                                             ...
                                             <div class="col-md-2">
                                                <table border='0'>
                                                    <tr><td><b>Sub Category Identifier</b></td></tr>    
                                             ...
                                             <div class="col-md-2">
                                                <table border='0'>
                                                    <tr><td><b>Sub Category Name</b></td></tr>    
                                    ...
                                    <a href="subcategory-list.php?cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>"><button type="button" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="licon-refresh"></i> Reset</button></a>
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo DIR_WS_ASSETS?>vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                    <div align="left">
                <a href="<?php echo $domain?>admin/sub-category-entry.php?cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>" class="btn btn-default">Add</a>
                <a href="#"  onclick="javascript:return callDelete();" class="btn btn-default">Delete</a>
                <a href="<?php echo $domain?>admin/category-list.php" class="btn btn-default" id="myButton">Cancel</a>
                    </div>
                    <br>
                    <thead>
                        <tr>
                            <th width="5%"></th>
                            <th width="5%">ID</th>
                            <th width="25%">Sub Category Identifier</th>
                            ...
                            <th width="5%">Edit</th>
                            <th width="15%">Add Sub Subcategory</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                        $objd = new db_sub_sub_category_master();
                        if($internet[0]>0):
                            $i=0;
                        ...
                        $sub_category_master_date    = $objinternet->sub_category_master_date;
                        $cdate         =  date("jS F Y h:i:s", strtotime($sub_category_master_date)); 
                        $sub_category_master_date1    = $objinternet->sub_category_master_date1;
                        $mdate         =  date("jS F Y h:i:s", strtotime($sub_category_master_date1)); 

                        $strWhere1 = "sub_category_master_id=".$objinternet->sub_category_master_id;
                        $del  = $objd->selectAll($strWhere1,$cur,$max);
                    ?>
                        <tr class="gradeX">
                            <?php if($del[0]>0):?>
                            <td><input type="checkbox" disabled="disabled" title="Cannot delete. Sub Sub Category present for this Sub Category"/></td>
                            <?php else:?>   
                            <td><input type="checkbox" name="chk<?php echo $i?>" value="<?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?>"/></td>
                            <?php endif;?>
                            <td><?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->sub_category_master_name_urdu,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->sub_category_master_name,ENT_QUOTES, 'UTF-8')?></td>
                            ...
                            <td align="center"><a href="<?php echo $domain?>admin/sub-category-entry.php?sid=<?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo htmlspecialchars($objinternet->category_master_id,ENT_QUOTES, 'UTF-8')?>"><img src="<?php echo DIR_WS_ASSETS?>images/user_edit.png" alt="Edit" title="Edit"/></a></td>
                             <td align="left"><input type="submit" value="Add Sub Sub category" formaction="<?php echo $domain?>admin/sub-sub-category-list.php?sid=<?php echo htmlspecialchars($objinternet->sub_category_master_id,ENT_QUOTES, 'UTF-8')?>&cid=<?php echo $cid?>" /></td>
                        </tr>
                    <?php
                            endwhile;
                        endif;
...
<script language="javascript" type="TEXT/JAVASCRIPT">
    ...
    function callDelete(){
        ...
        {
          document.frminternet.action="<?php echo $domain?>admin/subcategory-submit.php?mode=Delete&cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>";
 ...
 function callSearch()
        ...
        document.frminternet.action="subcategory-list.php?cid=<?php echo htmlspecialchars($cid,ENT_QUOTES, 'UTF-8')?>";
        document.frminternet.submit();
        }    
</script>
