        ...
        <header class="panel-heading"><h2 class="panel-title"><font color="red"><b><?php echo $objMsg->get_message()?></b></font></h2></header>
         <?php endif;?>
                <div class="panel-body">
                    <form name="frminternet" method="post" action="<?php echo $domain?>admin/poetry-entry.php">
            <div class="panel-body">
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo DIR_WS_ASSETS?>vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                    <div align="left">
                        <a href="<?php echo $domain?>admin/poetry-entry.php" class="btn btn-default">Add</a>
                    ...
                    ?>
                        <tr class="gradeX">
                            <td><input type="checkbox" name="chk<?php echo $i?>" value="<?php echo htmlspecialchars($objinternet->poetry_master_id,ENT_QUOTES, 'UTF-8')?>"/></td>
                            <td><?php echo htmlspecialchars($objinternet->poetry_master_title,ENT_QUOTES, 'UTF-8')?></td>
                            <td align="center"><a href="<?php echo $domain?>admin/poetry-entry.php?tid=<?php echo htmlspecialchars($objinternet->poetry_master_id,ENT_QUOTES, 'UTF-8')?>"><img src="<?php echo htmlspecialchars($objinternet->poetry_master_image,ENT_QUOTES, 'UTF-8');?>" border="0" width="100"></a></td>
                            <td><?php echo $stractive?></td>
                            <td align="center"><a href="<?php echo $domain?>admin/poetry-entry.php?tid=<?php echo htmlspecialchars($objinternet->poetry_master_id,ENT_QUOTES, 'UTF-8')?>"><img src="<?php echo DIR_WS_ASSETS?>images/user_edit.png" alt="Edit" title="Edit"/></a></td>
...
<script language="javascript" type="TEXT/JAVASCRIPT">
    ...
    function callDelete(){
        ...
        {
          document.frminternet.action="<?php echo $domain?>admin/poetry-submit.php?mode=Delete";
