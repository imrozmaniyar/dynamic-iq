...
<script src='script-mumbai-inner.js' type='text/javascript'></script>
              ...
              <div class="">
                      <div class="panel-body" >
                        <table border="4" width="50%" cellspacing="10" bgcolor="#00FF00" align="center" id="demo">
                          ...
                          <?php
                              $query = "select * from users_mumbai_inner order by position";
