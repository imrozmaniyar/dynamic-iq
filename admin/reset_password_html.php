			...
			<div class="center-sign">
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right">
						<h2 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Password Reset</h2>
					</div>
					<div class="panel-body">
				<form id="momm-signup" method="post">


							<div class="form-group mb-lg">

								<div class="input-group input-group-icon">
									<input type="password" name="password" tabindex="1" id="password" placeholder="Enter your new password" required="required" class="form-control input-lg" />
 ...
 -->
		...
		<script>
		    $(document).ready(function(e) {
		        $("#momm-signup").on('submit', function() {
