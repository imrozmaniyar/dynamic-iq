...
<script src='script-lifestyle.js' type='text/javascript'></script>
...
a :hover{
  color: hotpink;
    ...
    <header class="page-header">
        <h2>Home Lifestyle Priorities</h2>
              ...
              <div class="">
                      <div class="panel-body" >
                        <table border="4" width="50%" cellspacing="10" bgcolor="#00FF00" align="center" id="demo">
                          ...
                          <?php
                              $query = "select * from users_lifestyle order by position";
