        ...
        <header class="panel-heading"><h2 class="panel-title"><font color="red"><b><?php echo $objMsg->get_message()?></b></font></h2></header>
         <?php endif;?>
                <div class="panel-body">
                    <form name="frminternet" method="post" action="<?php echo $domain?>admin/admin_users_entry.php">
            <div class="panel-body">
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo DIR_WS_ASSETS?>vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                    <div align="left">
                    <a href="<?php echo $domain?>admin/admin_users_entry.php" class="btn btn-default">Add</a>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="15%">User Login</th>
                            <th width="15%">User Email</th>
                            <th width="15%">User Role</th>
                            <th width="5%">Status</th>
                            <th width="5%">Edit</th>
                            <th width="5%">Delete</th>
                            <th width="15%">Assign User Rights</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    ?>
                        <tr class="gradeX">
                            <td><input type="checkbox" name="chk<?php echo $i?>" value="<?php echo htmlspecialchars($objinternet->admin_id,ENT_QUOTES, 'UTF-8')?>"/></td>
                            <td><?php echo htmlspecialchars($objinternet->admin_name,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->admin_login,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->admin_email,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo htmlspecialchars($objinternet->admin_role,ENT_QUOTES, 'UTF-8')?></td>
                            <td><?php echo $stractive?></td>
                            <td align="center"><a href="<?php echo $domain?>admin/admin_users_entry.php?aid=<?php echo htmlspecialchars($objinternet->admin_id,ENT_QUOTES, 'UTF-8')?>"><img src="<?php echo DIR_WS_ASSETS?>images/user_edit.png" alt="Edit" title="Edit"/></a></td>
                            ...
                            <td align="center"><input type="submit" value="Assign Users Rights" formaction="<?php echo $domain?>admin/assign_rights.php?id=<?php echo htmlspecialchars($objinternet->admin_id,ENT_QUOTES, 'UTF-8')?>" /></td>
                        </tr>
                    <?php
                            endwhile;
                        endif;
                ...
                <input type="hidden" name="aid" id="aid" value="<?php echo htmlspecialchars($objinternet->admin_id,ENT_QUOTES, 'UTF-8')?>">
...
<script language="javascript" type="TEXT/JAVASCRIPT">
    ...
    function callDelete(){
        ...
        {
          document.frminternet.action="<?php echo $domain?>admin/admin_user_submit.php?mode=Delete";
