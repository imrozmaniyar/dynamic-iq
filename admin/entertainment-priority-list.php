...
<script src='script-ent-inner.js' type='text/javascript'></script>
...
a :hover{
  color: hotpink;
    ...
    <header class="page-header">
        <h2>Entertainment Priorities</h2>
              ...
              <div class="">
                      <div class="panel-body" >
                        <table border="4" width="50%" cellspacing="10" bgcolor="#00FF00" align="center" id="demo">
                          ...
                          <?php
                              $query = "select * from users_ent_inner order by position";
