      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            <li class="breadcrumb-item font-weight-bold"><a href="#" alt="Film" title="Film"> فلم</a></li>
        ...
        <?php include('film-one.php'); ?>        
      </div>  
    </section>
    <!-- first section -->
    <!-- article-news-listing Section -->
    <!-- article-news-listing Section -->
    <?php include('film-two.php'); ?>
...
$entfFour    = $objentfFour->selectAll($strWhere, 13, 3);
?>    
<section class="mt-3">
