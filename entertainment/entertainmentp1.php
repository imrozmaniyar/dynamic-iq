<?php
      if ($entinner1[0] > 0):
        $i = 1;
          while ($objentinner1s = mysql_fetch_object($entinner1[1])):
          $username           = $objentinner1s->username;
          $nameID             = $objentinner1s->name;
          if($username     =='Article'):
...
<div class="row">
  ...
  <div class="col-md-6 order-1 order-md-2"><a href="<?php echo $domain?>entertainment/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href"><img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto first-section-img" title="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>" alt="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>"></a></div>
</div>
<?php
  endwhile;
endif;  
