<?php
      if ($sportsinner1[0] > 0):
        $i = 1;
          while ($objsportsinner1s = mysql_fetch_object($sportsinner1[1])):
          $username           = $objsportsinner1s->username;
          $nameID             = $objsportsinner1s->name;
          if($username     =='Article'):
...
<div class="row">
  ...
  <div class="col-md-6 order-1 order-md-2"><a href="<?php echo $domain?>sports/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href"><img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto first-section-img" alt="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>" alt="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>"></a></div>
</div>
<?php
  endwhile;
endif;  
