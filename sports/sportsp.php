...
<?php
      if ($sportsinner2[0] > 0):
        $i = 1;
          while ($objsportsinner2s = mysql_fetch_object($sportsinner2[1])):
          $username           = $objsportsinner2s->username;
          $nameID             = $objsportsinner2s->name;
          if($username     =='Article'):
...
?>  
  <div class="col-md-3 zoom col-6 mt-3">
    <a href="<?php echo $domain?>sports/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href">
      <img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" style="height:165px;" class="img-fluid mx-auto d-block first-section-sub-section-img" alt="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>" Title="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>">
