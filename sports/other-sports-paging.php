...
$strWhere1 = "article_id < $last_blog_id and category_id=16 and sub_category_id=18 and active='Y'";
...
?>
 ...
 <?php if ($cricketPaging[0] > 3) { ?><div id="remove_row"><div class="mt-5 mb-5"><img src="<?php echo $domain?>images/load-more-btn.png" class="img-fluid d-block mx-auto align-self-center" data-bid="<?php echo $aID; ?>" id="btn_more"></div>
 </div>
<?php }else{ ?>
