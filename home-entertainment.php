...
<h1 class="lifestyle-section-title mb-3"><a href="<?php echo $domai?>entertainment">طفریح </a></h1>
<?php
 if ($EntPhoto[0] > 0):
        $i = 1;
...
?>	
	<a href="<?php echo $domai?>entertainment" class="float-left read-more mt-3">مزید </a>
</div>