...
<h1 class="lifestyle-section-title mb-3"><a href="<?php echo $domain?>features/literature"> ادب </a></h1>
<?php
 if ($Literature[0] > 0):
        $i = 0;
...
<a href="<?php echo $domain?>features/literature" class="float-left read-more mt-3">مزید </a>
</div>