...
<h1 class="lifestyle-section-title mb-3"><a href="<?php echo $domain?>news/mumbai">ممبئی</a></h1>
<?php
 if ($MumbaiPhoto[0] > 0):
        $i = 1;
...
?>	
	<a href="<?php echo $domain?>news/mumbai" class="float-left read-more mt-3">مزید </a>
</div>