...
$strWhere = "category_id=17 and sub_category_id=22 and active='Y'";
$sunday    = $objsunday->selectAll($strWhere, 0, 4);
///// Home Sunday Magazine //////
///// Home Jumma Magazine //////
$objjumma = new db_article_master;
$strWhere = "category_id=17 and sub_category_id=21 and active='Y'";
$jumma    = $objjumma->selectAll($strWhere, 0, 4);
///// Home Jumma Magazine //////
///// Home Literature  //////
$objLiterature  = new db_article_master;
$strWhere = "category_id=17 and sub_category_id=23 and active='Y'";
...
$strWhere = "category_id=19 and sub_category_id=29 and active='Y'";
...
$strWhere = "category_id=14 and sub_category_id=11 and active='Y'";
$newsnationalSingle    = $objnewsnationalSingle->selectAll($strWhere, 0, 1);
///// News National Single Large //////
///// News interNational //////
...
$strWhere = "category_id=14 and active='Y'";
...
$strWhere = "category_id=15 and sub_category_id=15 and active='Y'";
...
$strWhere = "category_id=16 and sub_category_id=17 and active='Y'";
...
$strWhere = "category_id=17 and sub_category_id=19 and active='Y'";
...
$strWhere = "category_id=18 and sub_category_id=25 and active='Y'";
