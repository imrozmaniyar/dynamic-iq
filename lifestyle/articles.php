      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            <li class="breadcrumb-item font-weight-bold" alt="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>"><a href="<?php echo $domain?>lifestyle/<?php echo strtolower($Sname1);?>" alt="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>"><?php echo htmlspecialchars($SUname,ENT_QUOTES, 'UTF-8')?></a></li>            
            <li class="breadcrumb-item active font-weight-bold" aria-current="page"><a href="<?php echo $domain?>lifestyle" alt="<?php echo htmlspecialchars($Ename,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($Ename,ENT_QUOTES, 'UTF-8')?>"> <?php echo htmlspecialchars($Uname,ENT_QUOTES, 'UTF-8')?>  </a></li>
