<section class="mt-3">
  <div class="container clearfix">
    <div class="news-section-bg p-3">
      <div class="col-md-12"><h1 class="lifestyle-section-title"><a href="<?php echo $domain?>lifestyle/youth">  جوانی  </a></h1></div>
        <div class="news-section-inner-bg p-3">
          ...
          ?>    
              <div class="col-md-5 order-0 order-md-1">
                ...
                <a href="<?php echo $domain?>lifestyle/youth" class="text-right read-more mt-1">مزید </a>
              </div>
          <?php
            endwhile;
          endif;  
