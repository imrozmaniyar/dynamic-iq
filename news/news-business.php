<section class="mt-3">
  <div class="container clearfix">
    <div class="news-section-bg p-3">
      <div class="col-md-12"><h1 class="lifestyle-section-title"><a href="<?php echo $domain?>news/business">کاروبار۔  </a></h1></div>
        ...
        <div class="row">
         ...
         <?php
          ...
          <div class="col-md-5 order-0 order-md-1">
            <a href="<?php echo $domain?>news/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href">
              <img src="<?php echo htmlspecialchars($aImage,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto news-national-sub-section-img" alt="<?php echo htmlspecialchars($ahp,ENT_QUOTES, 'UTF-8')?>">
            ...
            <a href="<?php echo $domain?>news/business" class="text-right read-more mt-1">مزید </a>
          </div>
          <?php
            endwhile;
          endif;  
