<section class="mt-3">
  <div class="container clearfix">
    <div class="news-section-bg p-3">
      <div class="col-md-12"><h1 class="lifestyle-section-title"><a href="<?php echo $domain?>news/international" title="International" alt="International"> عالم </a></h1></div>
         ...
         <?php
          ...
          ?>           
               <div class="col-md-5 order-0 order-md-1">
                ...
                ?>
                <a href="<?php echo $domain?>news/international" class="text-right read-more mt-1" title="More" alt="More">مزید </a>
              <?php endif;?>
              </div>
          <?php
            endwhile;
