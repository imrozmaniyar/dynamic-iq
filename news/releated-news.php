...
<?php
    ...
    while ($objreleatedNewsS       = mysql_fetch_object($releatedNews[1])):
      ...
      $j                             = $j + 1;
?>      
      <div class="col-md-3 zoom col-6"><a href="<?php echo $domain?><?php echo htmlspecialchars($arcatname,ENT_QUOTES, 'UTF-8')?>/articles/<?php echo htmlspecialchars($arurl1,ENT_QUOTES, 'UTF-8')?>-<?php echo htmlspecialchars($arID,ENT_QUOTES, 'UTF-8')?>" class="home-href"><img src="<?php echo $domain?><?php echo htmlspecialchars($arimage,ENT_QUOTES, 'UTF-8')?>" class="img-fluid mx-auto d-block first-section-sub-section-img" alt=""><p class="first-section-sub-desc"><?php echo htmlspecialchars($arheadline,ENT_QUOTES, 'UTF-8')?></p></a></div>
<?php
    endwhile;
  endif;  
?>    
