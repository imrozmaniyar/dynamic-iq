      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            <li class="breadcrumb-item font-weight-bold" alt="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>"><a href="<?php echo $domain?>news/<?php echo strtolower($SEname);?>" alt="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($SEname,ENT_QUOTES, 'UTF-8')?>"><?php echo htmlspecialchars($SUname,ENT_QUOTES, 'UTF-8')?></a></li>
            <li class="breadcrumb-item active font-weight-bold" aria-current="page"><a href="<?php echo $domain?>news" alt="<?php echo htmlspecialchars($Ename,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($Ename,ENT_QUOTES, 'UTF-8')?>"> <?php echo htmlspecialchars($Uname,ENT_QUOTES, 'UTF-8')?>  </a></li>
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-1 text-right order-0 order-md-1 mb-3 mb-md-0">
            <a href="https://www.facebook.com/sharer.php?u=<?php echo $domain?>news/articles/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="mr-2 mr-md-0" target="_blank"><img src="<?php echo $domain?>images/fb-icon.png" class="img-fluid mx-auto"></a>
            <a href="https://twitter.com/share?url=<?php echo $domain?>news/articles/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>&amp;text=<?php echo htmlspecialchars($articleHeadline,ENT_QUOTES, 'UTF-8')?>!&amp;amp;via=theinquilabin&amp;amp;" class="mr-2 mr-md-0" target="_blank"><img src="<?php echo $domain?>images/tweet-icon.png" class="img-fluid mt-md-2 mx-auto"></a>
                        <?php $isMobile = (bool) strpos($_SERVER['HTTP_USER_AGENT'],'Mobile'); if ($isMobile) :?>
            <a href="whatsapp://send?text=<?php echo $domain?>news/articles/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8');?>" data-action="share/whatsapp/share" target="_blank"><img src="<?php echo $domain?>images/whatsapp-icon.png" class="img-fluid mt-md-2 mx-auto"></a>
            <?php endif;?>
