    ...
    <div class="row">
      <div class="col-md-5 mx-auto text-left">
        <form method="post" action="<?php echo $domain?>checkmember" class="register-placeholder">
          ...
          <!-- <fb:login-button show-faces="false" scope="email" size="xlarge" onlogin="login()" onlogin="window.location.reload(true);"></fb:login-button> -->
        <!--   <?php $isMobile = (bool) strpos($_SERVER['HTTP_USER_AGENT'],'Mobile'); if ($isMobile):?>
          <div class="g-signin2" data-onsuccess="onSignIn" data-theme="dark" style="height:36px;width: 331px;"></div>
          <?php else:?>
          <div class="g-signin2" data-onsuccess="onSignIn" data-theme="dark" style="height: 35px;width: 451px;"></div>
        <?php endif;?> -->
