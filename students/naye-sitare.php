      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            <li class="breadcrumb-item font-weight-bold"><a href="#" alt="Naye Sitare" title="Naye Sitare">  نئے ستارے  </a></li>
            <li class="breadcrumb-item active font-weight-bold" aria-current="page"><a href="<?php echo $domain?>children" class="text-black" alt="Student" title="Student"> طلبہ </a></li>
...
<section class="mt-3">
  <div class="container clearfix" id="load_data_table">
    <h2 class="article-news-listing-title" alt="Naye Sitare" title="Naye Sitare">  نئے ستارے  </h2>
<?php
  if ($entfFour[0] > 0):
    $i = 1;
