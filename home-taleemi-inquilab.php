    ...
    <section class="mt-3">
      <div class="container clearfix">
        <div class="photo-section-bg p-3">
          <div class="col-md-12">
            <h1 class="photo-section-title"><a href="<?php echo $domain?>students/taleemi-inquilab" class="text-white"> تیلیمی انکیلاب۔  </a></h1>
           </div>
          <div class="row">
<?php            
 if ($tq[0] > 0):
...
?>            
            <a href="<?php echo $domain?>students/taleemi-inquilab" class="text-left read-more mt-3">مزید </a>
          </div>
        </div>
      </div>  
    </section>
