...
$strWhere1 = "article_id < $last_blog_id and category_id=17 and sub_category_id=32 and active='Y'";
...
<?php }else{ ?>
<?php echo "<div class='mt-5 mb-5'><div id='remove_row' align='center'><font color='Red'><b>No More date</b></font></div></div>" ?>
<?php } ?>   
<?php
}
?>