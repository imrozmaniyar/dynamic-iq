      ...
      <div class="container clearfix">
        <nav aria-label="breadcrumb" class="clearfix">
          <ol class="breadcrumb float-right mb-0 pb-0 news-breadcrumb">
            <li class="breadcrumb-item font-weight-bold text-black" alt="Editorial" title="Editorial">  اداریہ  </a></li>
...
<section class="mt-3">
  <div class="container clearfix" id="load_data_table">
    <h2 class="article-news-listing-title" alt="Editorial" title="Editorial">  اداریہ </h2>
<?php
  if ($entfFour[0] > 0):
    $i = 1;
