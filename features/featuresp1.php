...
<div class="row">
  ...
  <div class="col-md-6 order-1 order-md-2"><a href="<?php echo $domain?>features/<?php echo htmlspecialchars($url,ENT_QUOTES, 'UTF-8')?>" class="home-href"><img src="<?php echo htmlspecialchars($hi,ENT_QUOTES, 'UTF-8')?>" class="img-fluid d-block mx-auto" alt="<?php echo htmlspecialchars($ht,ENT_QUOTES, 'UTF-8')?>" width="525px;" height="300px;"></a></div>
</div>
<?php
  endwhile;
endif;  
