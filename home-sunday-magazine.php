...
?>
<?php if($i==1):?>	
    <img src="<?php echo htmlspecialchars($article_image1,ENT_QUOTES, 'UTF-8')?>" class="img-fluid other-section-img" alt="<?php echo htmlspecialchars($article_homepage_headline,ENT_QUOTES, 'UTF-8')?>" title="<?php echo htmlspecialchars($article_homepage_headline,ENT_QUOTES, 'UTF-8')?>">
...
?>    
    ...
    <a href="#" class="home-href"><p class="horizontal-border-content-seperator mt-3 pb-3 lifestyle-section-desc">رات بھر رویا کرتی تھیں اس اداکار کی بیوی، کیا چونکانے والا انکشاف: جانیں یہاں</p></a>
    <a href="#" class="home-href"><p class="horizontal-border-content-seperator mt-3 pb-3 lifestyle-section-desc">رات بھر رویا کرتی تھیں اس اداکار کی بیوی، کیا چونکانے والا انکشاف: جانیں یہاں</p></a> -->
    <a href="<?php echo $domain?>features/sunday-magazine" class="float-left read-more mt-3" Alt="More" title="More">مزید </a>
  </div>