    ...
    <div class="row">
      <div class="col-md-10 mx-auto text-left">
        <form method="post" action="<?php echo $domain?>checkmember" class="register-placeholder">
         ...
         Your Account not verified yet. An e-mail has been sent to your email id with an activation link. Click the link to activate your account. Kindly check your Junk/Spam folder in case you dont receive the mail in inbox. 
        </h4>
        </form>  
        <br>
        <br>
